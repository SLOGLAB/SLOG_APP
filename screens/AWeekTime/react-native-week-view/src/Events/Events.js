...
import { TIME_LABEL_HEIGHT, CONTAINER_HEIGHT, calculateDaysArray, DATE_STR_FORMAT } from "../utils"
...
class Events extends PureComponent {
  ...
  render() {
    const { eventsByDate, initialDate, numberOfDays, times, onEventPress } = this.props
