...
const FeedPresenter = ({
  ...
  return (
    <Container>
      ...
      {/* <Swiper showsPagination={false} style={{ height: 200, width: 200 }}> */}
      {/* <SwipeView> */}
      {files.map((file) => (
        <Image
          style={{ height: constants.height / 3, width: constants.width / 2 }}
          key={file.id}
          source={{ uri: file.url }}
        />
      ))}
...
export default withNavigation(FeedPresenter)
