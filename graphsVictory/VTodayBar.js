      ...
      >
        ...
        >
          <VictoryArea
            ...
            data={[
              { x: 0, y: 0 },
              { x: 1, y: taskArray_pre[0] },
              { x: 2, y: taskArray_pre[1] },
              { x: 3, y: taskArray_pre[2] },
              { x: 4, y: taskArray_pre[3] },
              { x: 5, y: taskArray_pre[4] },
              { x: 6, y: taskArray_pre[5] },
              { x: 7, y: taskArray_pre[6] },
              { x: 8, y: taskArray_pre[7] },
              { x: 9, y: taskArray_pre[8] },
              { x: 10, y: taskArray_pre[9] },
              { x: 11, y: taskArray_pre[10] },
              { x: 12, y: taskArray_pre[11] },
              { x: 13, y: taskArray_pre[12] },
              { x: 14, y: taskArray_pre[13] },
              { x: 15, y: taskArray_pre[14] },
              { x: 16, y: taskArray_pre[15] },
              { x: 17, y: taskArray_pre[16] },
              { x: 18, y: taskArray_pre[17] },
              { x: 19, y: taskArray_pre[18] },
              { x: 20, y: taskArray_pre[19] },
              { x: 21, y: taskArray_pre[20] },
              { x: 22, y: taskArray_pre[21] },
              { x: 23, y: taskArray_pre[22] },
              { x: 24, y: taskArray_pre[23] },
            ]}
          />
        </VictoryGroup>
        <VictoryGroup
